...
class CorsMiddleware
{
    public function handle($request, Closure $next)
    {
        if ($request->isMethod('OPTIONS')) {
            return response('', 200)
                // ->header('Access-Control-Allow-Origin', 'http://147.229.117.40:3000') // Add your React app's domain here
        ...
        // $response->headers->set('Access-Control-Allow-Origin', 'http://147.229.117.403000'); // Add your React app's domain here
